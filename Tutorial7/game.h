#include "point.h"		// for std::vector
...
struct SCharacter { // holds character data
	...
	int											x		// Coordinates in tile map
		,										z
		;												
	SVector2D									PositionDeltas;	// Intermediate tile position between 0 and 0.9999999999999999999999999999999999999999999998 or so
